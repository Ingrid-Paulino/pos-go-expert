...
const createCategoryWithResult = `-- name: CreateCategoryWithResult :execresult
INSERT INTO categories (id, name, description) VALUES (?, ?, ?)
`

type CreateCategoryWithResultParams struct {
	ID          string
	Name        string
	Description sql.NullString
}

func (q *Queries) CreateCategoryWithResult(ctx context.Context, arg CreateCategoryWithResultParams) (sql.Result, error) {
	return q.db.ExecContext(ctx, createCategoryWithResult, arg.ID, arg.Name, arg.Description)
}
