...
func (p *Product) FindAll(page, limit int, sort string) ([]entity.Product, error) {
	...
	if page != 0 && limit != 0 { //Se for diferente de 0 faz busca com paginação //limit: quantidade de registros por pagina //offset: Qual pagina vc esta (sempre começa do 0)
