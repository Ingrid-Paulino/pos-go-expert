...
import (
	...
	entityPkg "github.com/Ingrid-Paulino/pos-go-expert/APIs/pkg/entity"
...
func (h *ProductHandler) CreateProduct(w http.ResponseWriter, r *http.Request) {
	...
	//essa parte geralmente é feita no service(usecase) e nn no handler
...
func (h *ProductHandler) GetProduct(w http.ResponseWriter, r *http.Request) {
	id := chi.URLParam(r, "id") //Lib do CHI para pegar o id da rota
	if id == "" {
		w.WriteHeader(http.StatusBadRequest)
		return
	}
...
func (h *ProductHandler) GetProducts(w http.ResponseWriter, r *http.Request) {
	...
	pageInt, err := strconv.Atoi(page) // converte string pra int
	if err != nil {
		pageInt = 0
	}
