...
func main() {
	...
	t.Funcs(template.FuncMap{"ToUpper": ToUpper}) // Permite colocar um mapa de funções que quero que seja parseado dentro de t
	t = template.Must(t.ParseFiles(templates...)) //templates... -> funcao variadica, sig que cada valor do slice será um parametro
