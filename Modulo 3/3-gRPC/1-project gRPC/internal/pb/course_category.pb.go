...
type Category struct {
	...
	Id          string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"` //OBS: a nemeração é simplesmente uma ordem
...
type CategoryList struct {
	...
	Categories []*Category `protobuf:"bytes,1,rep,name=categories,proto3" json:"categories,omitempty"` //repeated é usado para definir uma lista de elementos
}
...
var file_proto_course_category_proto_rawDesc = []byte{
	...
	0x65, 0x67, 0x6f, 0x72, 0x79, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x42, 0x0d, 0x5a, 0x0b, 0x69,
